...
import 'package:sliate_admin/screens/categories/log/student/check_department.dart';
import 'package:sliate_admin/screens/categories/log/student/student_signup_page.dart';
                  ...
                  onPressed: () {
                    if (usertype == 'admin') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: ((context) => const admin_signup()),
                        ),
                      );
                    } else {
                      Navigator.push(
